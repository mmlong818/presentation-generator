...
def build(slide: dict[str, Any], theme, n: int, total: int) -> list[dict]:
    ...
    for i, ev in enumerate(events):
        ...
        elements.append({
            ...
            "rotate": 0,
            "content": simple(ev.get("time", ""), color=theme.accent, font_size_px=sfont(28), bold=True, align="center"),
        ...
        elements.append({
            ...
            "rotate": 0,
            "content": simple(ev.get("title", ""), color=theme.text, font_size_px=sfont(28), bold=True, align="center"),
            "defaultFontName": theme.font_body,
        ...
        if desc := ev.get("desc"):
            elements.append({
                ...
                "rotate": 0,
                "content": simple(desc, color=theme.muted, font_size_px=sfont(20), align="center"),
                "defaultFontName": theme.font_body,
